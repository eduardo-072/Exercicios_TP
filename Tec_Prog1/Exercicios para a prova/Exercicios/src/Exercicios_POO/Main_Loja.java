...
public class Main_Loja {
    ...
    public static void main(String[] args) {
        ...
        while (!sair) {
            ...
            switch (opcao) {
                case 1:
                    System.out.println("Digite o código do produto para comprar (1 - " + lojaDSM.getQtd() + "): ");
                    
                    int codCompra = sc.nextInt();
                    System.out.print("Digite a quantidade para comprar: ");
                    int qtdCompra = sc.nextInt();

                    String resCompra = lojaDSM.comprarProduto(codCompra, qtdCompra);
                    System.out.println(resCompra);
                    break;

                case 2: 
                    System.out.print("Digite o código do produto para devolver (1 - " + lojaDSM.getQtd() + "): ");
                    int codRepor = sc.nextInt();
                    System.out.print("Digite a quantidade para devolver: ");
                    int qtdRepor = sc.nextInt();

                    String resRepor = lojaDSM.devolverProduto(codRepor, qtdRepor);
